      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Ambika</h2>
              <p className="text-sm text-gray-600 leading-relaxed">
                Building a sustainable future through innovation and excellence across energy, retail, and digital services.
              </p>
            </div>
          ...
          {/* Links Sections */}
          {Object.entries(businessLinks).map(([title, links]) => (
            <div key={title}>
        ...
        <div className="border-t border-gray-200 pt-8 mb-8">
          <div className="max-w-2xl">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Get the latest news and updates on our sustainable initiatives and business developments.
            </p>
